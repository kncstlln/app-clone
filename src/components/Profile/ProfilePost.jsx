            ...
            <Flex gap={4} w={{base: "90%", sm: "70%", md: "full"}} mx={"auto"}> 
              ...
              <Flex flex={1} flexDir={"column"} px={10} display={{base:"none", md:"flex"}}>
                ...
                <Flex alignItems={"center"} gap={4}>
                  ...
                  <Avatar src='/profilepic.png' size={"sm"} name='Kane Castillano' />
              ...
              <VStack w='full' alignItems={"start"} maxH={"350px"} overflowY={"auto"}>
                <Comment createdAt='1d ago' username='Jello Mangune' profilepic='/profilepic.png' text={"Wow?"} />
                <Comment createdAt='2h ago' username='Karylle Lopez' profilepic='/profilepic.png' text={"Hello, Kane!"} />
                <Comment createdAt='1h ago' username='Stephanie Basilio' profilepic='/profilepic.png' text={"TwistResources"} />
              </VStack>
